  ...
  public:
    ...
    static bool StoreNewUser(kUser* pk_NewUser)
    {
      for (int U = 0; true; U++)
      {
        ...
        {
          SER.print("Error: The EEPROM is full\r\n");
          return false;
        }
      ...
      SER.print("New user stored successfully:\r\n");
    ...
    static void PrintUser(kUser* pk_User)
    {
      ...
      SER.printHexBuf(pk_User->ID.u8, 7);

      switch (pk_User->u8_Flags & DOOR_BOTH)
      {
        case DOOR_ONE:  SER.print("   (door 1)\r\n");            break;
        case DOOR_TWO:  SER.print("   (door 2)\r\n");            break;
        case DOOR_BOTH: SER.print("   (door 1 + 2)\r\n");        break;
        default:        SER.print("   (no door specified)\r\n"); break;
      }
    }

    static void ListAllUsers()
    {
      SER.print("Users stored in EEPROM:\r\n");
