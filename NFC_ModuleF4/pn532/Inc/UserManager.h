...
public:
    static void DeleteAllUsers()
    {
		...
		#else
			Serial.print("Delete all users is not supported" ,LF);
		#endif
    }
...
private:
    ...
    static bool WriteUserAt(int s32_Index, kUser* pk_User)
    {
		...
		#else 
			Serial.print("Write users at is not supported" ,LF);
			return false;
		#endif
        return true;
    }
    ...
    static bool ReadUserAt(int s32_Index, kUser* pk_User)
    {
		...
		#else
			Serial.print("Read users at is not supported" ,LF);
			return false;
		#endif
        return true;
    }
    ...
    static bool ShiftUsersUp(int U)
    {
		...
		#else
			Serial.print("Shift users up is not supported" ,LF);
			return false;
		#endif
        return true;
    }
