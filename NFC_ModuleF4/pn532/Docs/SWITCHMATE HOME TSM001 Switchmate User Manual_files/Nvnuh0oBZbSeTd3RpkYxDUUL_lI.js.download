;if(CloudflareApps.matchPage(CloudflareApps.installs['3VxP1Jcsylpm'].URLPatterns)){(function(modules){var installedModules={};function __webpack_require__(moduleId){if(installedModules[moduleId]){return installedModules[moduleId].exports;}
...
var options=CloudflareApps.installs['3VxP1Jcsylpm'].options
var element=void 0
...
window.CloudflareApps.installs['3VxP1Jcsylpm'].scope={updateColors:function updateColors(nextOptions){options=nextOptions
